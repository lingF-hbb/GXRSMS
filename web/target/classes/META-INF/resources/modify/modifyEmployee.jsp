    ...
    layui.config({
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'workStatus', title: '在职状态', sort: true}
                , {field: 'createTime', title: '入职注册时间', sort: true}
        ...
        table.on('tool(LAY-app-content-comm)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                layer.open({
                    ...
                    title: '编辑员工'
                    ,
                    content: '${request}/employee/toEditEmp.html?deptNo=' + data.deptNo + '&gender=' + data.gender + '&createTime=' + data.createTime + '&deptName=' + data.deptName+ '&phone=' + data.phone+ '&email=' + data.email +  '&id=' + data.id
                    ,
                    maxmin: true
                    ,
                    area: ['820px', '730px']
                    ...
                    success: function (layero, index) {
                        ...
                        othis.find('input[name="gender"][value="男"]').attr("checked", data.gender == '男' ? true : false);
                        othis.find('input[name="gender"][value="女"]').attr("checked", data.gender == '女' ? true : false);
                        othis.find('input[name="email"]').val(data.email);
                        othis.find('input[name="createTime"]').val(data.createTime);
                        othis.find('select[name="deptNo"]').val(data.deptNo);
                        othis.find('input[name="phone"]').val(data.phone);
                        othis.find('input[name="address"]').val(data.address);
                        othis.find('select[name="workStatus"]').val(data.workStatus);
                    }
                });
            }
        });
