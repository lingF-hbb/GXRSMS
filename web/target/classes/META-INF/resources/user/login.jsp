    ...
    <div class="layadmin-user-login-main">
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            <div class="layui-form-item">
                ...
                <input type="text" name="username" id="LAY-user-login-username" autocomplete="off" lay-verify="required"
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;">
                ...
                <a href="${request}/forget/toForget.html" class="layadmin-user-jump-change layadmin-link"
            ...
            <div class="layui-trans layui-form-item layadmin-user-login-other">
                ...
                <a href="${request}/registe/toRegiste.html" class="layadmin-user-jump-change layadmin-link">注册帐号</a>
            </div>
        </div>
    </div>
...
<script src="${request}/static/custom/js/external/gVerify.js"></script>
<%--图形验证码的放置与验证--%>
<script src="${request}/static/custom/js/getCookie.js"></script>
...
<script>
    layui.config({
        ...
        form.on('submit(LAY-user-login-submit)', function (obj) {
            ...
            $.ajax({
                type: 'post'
                , url: '${request}/login' //实际使用请改成服务端真实接口
                ...
                , success: function (res) {
                    ...
                    if (res.code === 100) {
                        ...
                        layer.msg('登入成功', {
                            ...
                            location.href = '${request}/index.html'; //后台主页
                        });
                    } else {
                        layer.msg(res.msg, {
                            offset: '15px'
