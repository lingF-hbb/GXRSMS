    ...
    <div class="layui-layout layui-layout-admin">
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    <a href="javascript:;">
                        <img src="${request}${user.icon}" class="layui-nav-img">${user.nickName}
                    </a>
                    <dl class="layui-nav-child">
                        ...
                        <hr>
                        <dd style="text-align: center;"><a href="${request}/layout">退出</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="content">
                                ...
                                <dl class="layui-nav-child">
                                    ...
                                    <dd data-name="money"><a lay-href="${request}/main/toMoneyList.html">薪资信息查询</a></dd>
                                    <dd data-name="good"><a lay-href="${request}/main/toGoodList.html">奖惩信息查询</a></dd>
                                </dl>
                            </dd>
                            <dd data-name="forum">
                                ...
                                <dl class="layui-nav-child">
                                    ...
                                    <dd data-name="money"><a lay-href="${request}/main/toModifyMoney.html">薪资信息修改</a></dd>
                                    <dd data-name="good"><a lay-href="${request}/main/toModifyGood.html">奖惩信息修改</a></dd>
                                </dl>
                            </dd>
                        </dl>
                    </li>
        ...
        <div class="layadmin-pagetabs" id="LAY_app_tabs">
            ...
            <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
                <ul class="layui-tab-title" id="LAY_app_tabsheader">
                    <li lay-id="main/toHome.html" lay-attr="index.html" class="layui-this"><i
